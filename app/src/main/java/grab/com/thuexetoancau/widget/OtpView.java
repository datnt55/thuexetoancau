...
public class OtpView extends LinearLayout {
    ...
    private void setEditTextInputStyle(TypedArray styles) {
        ...
        String textHint = styles.getString(R.styleable.OtpView_otp_hint);
        if (!TextUtils.isEmpty(text) && text.length() == 6) {
            ...
            /*mOtpOneField.setHint(String.valueOf(textHint.charAt(0)));
            mOtpTwoField.setHint(String.valueOf(textHint.charAt(1)));
            mOtpThreeField.setHint(String.valueOf(textHint.charAt(2)));
            mOtpFourField.setHint(String.valueOf(textHint.charAt(3)));*/
        }
        setFocusListener();
